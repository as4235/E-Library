<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="adminauthormanagement.aspx.cs" Inherits="API.adminauthormanagement" %>
                     ...
                     <div class="col-md-4">
                        ...
                        <div class="form-group">
                            <div class="input-group">
                               ...
                               placeholder="Author ID"></asp:TextBox>
                  ...
                  <div class="row">
                     ...
                     <div class="col">
                        <asp:GridView class="table table-striped table-bordered" ID="GridView1" runat="server" 
                            OnSelectedIndexChanged="GridView1_SelectedIndexChanged" AutoGenerateColumns="False" DataKeyNames="author_id" DataSourceID="SqlDataSource1">
                            <Columns>
